...
このドキュメントでは、Chaosdを使用してディスク障害をシミュレートする方法について説明します。この機能により、ディスクの読み書き負荷（[dd](https://man7.org/linux/man-pages/man1/dd.1.html)を使用）やディスクの充填（[dd](https://man7.org/linux/man-pages/man1/dd.1.html)または[fallocate](https://man7.org/linux/man-pages/man1/fallocate.1.html)を使用）をシミュレートできます。

## コマンドラインモードを使用した実験の作成

このセクションでは、コマンドラインモードを使用してディスク障害実験を作成する方法について説明します。

実験を作成する前に、以下のコマンドを実行して、Chaosdがサポートするディスク障害の種類を確認できます：
...
現在、Chaosdはディスク読み込み負荷実験、ディスク書き込み負荷実験、およびディスク充填実験の作成をサポートしています。
...
### サービスモードを使用してディスクを満たすシミュレーション

#### ディスクを満たすシミュレーションのパラメータ
...
#### サービスモードを使用してディスクを満たすシミュレーションの例
